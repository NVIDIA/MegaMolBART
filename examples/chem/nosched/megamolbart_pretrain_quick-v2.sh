...
EXP_NAME=${ENCODER_TYPE}_${HOSTNAME}_nodes_${SLURM_JOB_NUM_NODES}_gpus_${SLURM_GPUS_PER_NODE}

DATA_MOUNT=/data/zinc_csv_split
CODE_MOUNT=/workspace/NeMo_MegaMolBART/
OUTPUT_MOUNT=/result
RESULTS_MOUNT=${OUTPUT_MOUNT}/nemo_experiments/${PROJECT}/${MEGAMOLBART_CONFIG_FILE}_${EXP_NAME}
