...
class MegaMolBARTModel(MegatronLMEncoderDecoderModel):
    ...
    def process_global_batch(self, global_batch):
        ...
        # print(f"device = {device} tokens_enc = {tokens_enc.device} tokens_dec = {tokens_dec.device} loss_mask = {loss_mask.device} labels = {labels.device} enc_mask = {enc_mask.device} dec_mask = {dec_mask.device}")
